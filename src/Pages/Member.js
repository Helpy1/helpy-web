           ...
           <aside className='w-full w-100% lg:w-[30%]'>
            ...
            <main className="w-full lg:w-[70%] mt-6 lg:mt-0 ">
                    ...
                    <div className="mb-6 grid grid-cols-2 md:grid-cols-4 gap-4">
                        {images.map((image, index) => (
                            <div key={index} className="relative">
                                <div
                                    onClick={() => toggleHeartFvrt(index)}
                                    className="cursor-pointer absolute right-[16px] bottom-[16px]"
                                >
                                    {favorites[index] ? (
                ...
                <div className="w-full mb-6 bg-white rounded-lg shadow-md p-6 relative">
                    ...
                    <div onClick={toggleAboutmeHeart} className="cursor-pointer absolute right-[16px] bottom-[16px]">
                        {isAboutmeFilled ? (
                            <FaHeart className="text-red-500 w-6 h-6" />
                        ) : (
                ...
                <div className="w-full bg-white rounded-lg shadow-md p-6 relative mb-6">
                    ...
                    <div onClick={toggleSeekingHeart} className="cursor-pointer absolute right-[16px] bottom-[16px]">
                        {isSeekingFilled ? (
                            <FaHeart className="text-red-500 w-6 h-6" />
                        ) : (
                            <FaRegHeart className="text-gray-400 w-6 h-6" />
                ...
                <div className="w-full bg-white rounded-lg shadow-md p-6 relative">
                    <div>
                        <h2 className="text-gray-600 text-lg font-semibold mb-2">Extra Details</h2>
                        ...
                        <div
                            ...
                            className="cursor-pointer absolute bottom-4 right-4 bg-gray-100 p-2 rounded-full shadow-md"
                        >
                            {isExtraDetailsFilled ? (
                                <FaHeart className="text-red-500 w-6 h-6" />
                            ) : (
                                <FaRegHeart className="text-gray-400 w-6 h-6" />
                            )}
